...
public class ThreadModelTest {
	...
	public void shouldReturnEmptySetIfNoBuggerMatches() throws Exception {
		...
		new SignificantInterval(mock(SignificantIntervalOccupier.class),
	...
	public void shouldBoggleToAswad() {
		ThreadModel thread = new ThreadModel("blahthread", null);
		thread.add(new SignificantInterval(new SignificantIntervalOccupier(PAGE_REQUEST,null), new LogInterval(new Interval(3000,7000))));
